    ...
    <div className="flex justify-center items-center pt-1">
      <button
        ...
        className="flex justify-center items-center gap-x-3 text-sm
         md:text-xl  hover:bg-[#414040] px-3 py-1 rounded-md md:"
      >
        <span> {like ? <AiTwotoneLike className="text-blue-500"/> : <AiOutlineLike/>}</span>
        <span className="text-sm md:text-lg">Me gusta</span>
      </button>
      <button
        className="flex justify-center items-center gap-x-3 text-sm md:text-xl hover:bg-[#414040] px-3 py-1 rounded-md"
      >
